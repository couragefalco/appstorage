...
from app import preprocess_file, compare_files, render_2d_projection, save_uploadedfile, upload_file_to_blob
...
async def create_file(file: UploadFile = File(...)):
    try:
        ...
        response = {
            ...
            "num_edges": num_edges,
            "cog": cog.tolist()  # Convert numpy array to list here
        }
